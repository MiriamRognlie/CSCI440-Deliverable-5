...
import scipy.stats
#Question 3: Is​ ​the​ ​director’s​ ​popularity​ ​(based​ ​on​ ​Facebook​ ​likes)​ ​statistically​ ​correlated​ ​with​ ​the ratings​ ​or​ ​the​ ​profitability​ ​of​ ​a​ ​film?​
#Create the MySQL Engine
engine = create_engine('mysql://root:blue@localhost:3306/imdb')#create connection to our movie database
conn = engine.connect()
conn.begin()
#Run a query so "data" is a table containing the rating for each movie and the number of likes its director has on Facebook
